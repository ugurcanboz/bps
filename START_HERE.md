# START HERE – G54.43.8E

Aktueller Stand: Deep-Sheet Scroll Intelligence für die QA-Bubble ist integriert. Öffne die App mit `?qa=capture`, öffne Analyse oder Fortschritt, scrolle im Sheet, tippe die QA-Bubble an und exportiere den JSON-Bericht. Im JSON ist jetzt der Block `deepSheet` entscheidend.
