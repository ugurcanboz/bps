...
const result={version:'G54.50.2A',checks:8-findings.length,expected:8,findings};console.log(JSON.stringify(result,null,2));process.exitCode=findings.length?1:0;
