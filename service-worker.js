"use strict";
const CACHE_NAME = "eignungstest-trainer-v630-dynamic-topnav-cache";
...
const CORE_ASSETS = [
  ...
  "./index.html?v=6.3.0",
  "./css/app.css?v=6.3.0",
  "./css/mobile.css?v=6.3.0",
  "./js/app.js?v=6.3.0",
  "./data/question-bank.js?v=6.3.0",
  "./data/cloud-config.js?v=6.3.0",
  "./manifest.json?v=6.3.0",
  "./icons/icon-180.png",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
...
self.addEventListener("fetch", event => {
  ...
  if (versionCritical) {
    event.respondWith((async () => {
      try {
        ...
        return caches.match(req) || caches.match("./index.html?v=6.3.0") || caches.match("./index.html");
      }
    })());
    return;
  }
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return caches.match("./index.html?v=6.3.0") || caches.match("./index.html");
    }
  })());
});
