"use strict";
const CACHE_NAME = "eignungstest-trainer-v705-clean-stable-cache";
...
const CORE_ASSETS = [
  ...
  "./index.html?v=7.0.5",
  "./css/app.css?v=7.0.5",
  "./css/mobile.css?v=7.0.5",
  "./js/app.js?v=7.0.5",
  "./data/question-bank.js?v=7.0.5",
  "./data/cloud-config.js?v=7.0.5",
  "./manifest.json?v=7.0.5",
  "./icons/icon-180.png",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
...
self.addEventListener("fetch", event => {
  ...
  if (versionCritical) {
    event.respondWith((async () => {
      try {
        ...
        return caches.match(req) || caches.match("./index.html?v=7.0.5") || caches.match("./index.html");
      }
    })());
    return;
  }
  ...
  event.respondWith((async () => {
    ...
    try {
      ...
      return caches.match("./index.html?v=7.0.5") || caches.match("./index.html");
    }
  })());
});
