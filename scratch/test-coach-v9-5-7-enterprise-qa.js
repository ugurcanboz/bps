...
if(!String(E.version).includes('9.5.7')) throw new Error('Wrong version: '+E.version);
...
console.log('V9.5.7 enterprise QA hardening OK', {version:E.version, qaScore:qa.score, dnaQuality:contract.quality, auditStatus:audit.status, health:health.ok});
