...
// Now run the full database audit check
const filesToLoad = [
...
if(!audit || audit.total < 400 || audit.avgQuality < 90) throw new Error('DNA audit weak on real DB: '+JSON.stringify(audit));
...
console.log('V9.5.8 phase C premium UX polish OK on v9 DB', {version:E.version, qaScore:qa.score, dnaQuality:contract.quality, auditStatus:audit.status, health:health.ok});
