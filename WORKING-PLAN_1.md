...
# Phase 24D – Visual Browser QA Sprachkurs

Status: PASS nach Korrektur.

Durchgeführt:
- Browser-Simulation iPhone SE, iPhone 16 Pro Max, iPad Air, Desktop
- Kontrolle von Buttons, Kacheln, Abständen, Schrift, Deep-Sheet-Höhe
- Korrektur sichtbarer Translation-Key
- Korrektur Touch-Ziele
- Dokumentation unter `docs/PHASE_24D_VISUAL_BROWSER_QA_REPORT.md`

Nächste Phase: 24E – Niveau-Auswahl und Kursnavigation.


## Phase 24F – Aufgaben-UI

- A1-Begrüßungen enthält jetzt eine spielbare Demo-Aufgabe.
- Antwortkarten, Auswahlzustand, Prüfen/Weiter-Flow und Feedback wurden ergänzt.
- Hilfe zeigt nur didaktischen Hinweis in der Hilfssprache und keine Lösung.
- CTC, Admin, Highscore und Teilnahmecode wurden nicht verändert.


## Phase 24I · Mobile UI Feinschliff
- Sprachkurs-Dashboard und Aufgaben-UI für iPhone SE, iPhone 16 Pro Max, iPad Air und Desktop geprüft.
- Touch-Ziele, Button-Breiten, Kachelabstände, Deep-Sheet-Scrollverhalten und Textumbrüche verbessert.
- CTC/Admin/Highscore wurden nicht verändert.
- Neuer Test: tests_phase24i_mobile_ui_polish.html.


## Phase 25 · Adaptive Lernengine
- Adaptive Engine eingebaut (`js/modules/language-adaptive-engine.js`).
- Dashboard und Aufgaben-UI zeigen Lernempfehlung.
- Fehlerprofil, Wiederholungsbedarf und Schwierigkeitsband werden berechnet.
- CTC/Admin/Highscore unverändert.
...
Der A1-Kursbaum wurde von Demo-Struktur auf 10 sichtbare Startlektionen erweitert. Jede Lektion besitzt DE/TR-Titel, Lernziel, Vokabelblock und erste technische Startaufgaben. CTC/Admin/Highscore wurden nicht verändert.

Neue Testdatei: tests_phase26a_a1_course_tree.html
Neue Dokumentation: docs_PHASE26A_A1_COURSE_TREE.md


## Phase 26C – Vokabeltrainer & Wiederholungssystem
- A1-Wortschatz wird aus vorhandenen Kursaufgaben erzeugt.
- Eigener Vokabeltrainer mit Status neu/kann ich/wiederholen.
- Dashboard und Schnellzugriff angebunden.
- CTC/Admin/Highscore unverändert.

### Phase 26C-FIX · UI & Multiple Choice Reparatur
Status: PASS
- Videoanalyse durchgeführt.
- Language-Course CSS um Dark-Glass-Hauptapp-Konformität erweitert.
- Click-/Touch-Routing für Sprachkursaktionen in Capture-Phase stabilisiert.
- Multiple Choice Auswahlzustand, Prüfen und Weiter abgesichert.
- CTC/Admin/Highscore unverändert.
...
- `docs_PHASE26D_AUDIO_LISTENING_FOUNDATION.md`
- `tests_phase26d_audio_listening_foundation.html`
...
- Fehlertraining-Karte im Sprachkurs-Dashboard ergänzt.
- Schnellzugriff „Meine Fehler“ öffnet echten Trainingsbereich.
- Offene Fehler werden aus `lessonState.wrongTaskIds` gesammelt.
- Erste offene Fehleraufgabe wird direkt geöffnet.
- Korrekt beantwortete Fehler verschwinden automatisch aus der Fehlerliste.
...
Umgesetzt:
- A1-Kurs auf 10 Lektionen mit je 39 Aufgaben erweitert.
- Gesamtumfang A1: 390 Aufgaben.
- Alle Lektionen enthalten Multiple Choice, Zuordnen, Lückentext, Satzbau, Vokabelkarte, Richtig/Falsch und Hörverständnis.
- DE/TR-Prompts, Hinweise und Erklärungen ergänzt.
- Vokabeltrainer, Fehlertraining und adaptive Engine bleiben kompatibel.
- CTC/Admin/Highscore wurden nicht verändert.

Nächster Schritt: Phase 26H oder direkte Smoke-QA nach Inhaltsausbau, anschließend Phase 27 KI-Lehrer v1.
...
Umgesetzt:
- Coach-Karte im Sprachkurs-Dashboard
- datenbasierte Empfehlung aus Fortschritt, Fehlern und Vokabelstatus
- Coach-Detailpanel
- Button „Empfehlung starten“
- kein Chatbot-Look
- CTC/Admin/Highscore nicht verändert

Nächster Schritt: Phase 27B – tiefere Schwächenanalyse nach Aufgabentypen und Lektionen.
...
Umgesetzt:
- Coach-Empfehlungskarten
- Prioritätslogik Fehler/Vokabeln/Aufgabentyp/Lektion/Weiterlernen
- Start-Aktionen
- Dokumentation
- Testdatei

Nächste Phase: 27D – Wiederholungs-Vorschläge und Coach-Session-Modus.

## Phase 27D – abgeschlossen
- Wiederholungssets aus Coach-Analyse ergänzt
- Start-Buttons nutzen bestehende Sprachkurs-Flows
- Keine Fremdbereiche verändert

## Phase 27E – Coach-Texte DE/TR

Erledigt:
- Coach-Textbibliothek DE/TR ergänzt.
- Coach nutzt Hilfssprache für Lernbegleitung.
- Empfehlungskarten und Wiederholungssets übersetzbar gemacht.
- Coach-Metriken und Buttons übersetzt.
- Testdatei und Dokumentation ergänzt.
...
Ergänzt wurde die echte Startlogik für Coach-Empfehlungen:
- Fehlertraining starten
- erste offene Fehleraufgabe öffnen
- Vokabeltraining direkt starten
- schwachen Aufgabentyp gezielt öffnen
- passende Lektion öffnen
- Fallback auf Weiterlernen

CTC/Admin/Highscore wurden nicht verändert.

---

# Phase 27G – Coach Daten-QA

## Umsetzung

- Coach-QA-Snapshot ergänzt
- Diagnostics um Coach-QA erweitert
- Empfehlungen gegen echte Datenquellen geprüft
- Startaktionen gegen vorhandene Sprachkurs-Flows geprüft
- QA-Dokumentation ergänzt
- Testdatei ergänzt
...
PASS. Phase 27 kann als Coach-v1 abgeschlossen betrachtet werden.

---

## Phase 28 – Sprachkurs Cloud-Sync

Status: PASS

Umgesetzt:
- `language-course-cloud-sync.js` ergänzt
- automatischer Push nach `saveProgress()`
- lokaler Cloud-Mirror
- Offline-Warteschlange
- Profil-Bridge zu `EGTUserDatabase`
- Dashboard-Karte „Cloud Sync“
- manuelle Aktionen „Sync jetzt“ und „Cloud laden“
- Testdatei `tests_phase28_language_course_cloud_sync.html`
...
Umsetzung:
- Sprachkurs-Modul um `speaking_practice` erweitert.
- Erste Sprechaufgabe in A1 Begrüßungen ergänzt.
- `Sprich jetzt` startet Web Speech Recognition, wenn verfügbar.
- Nicht unterstützte Browser erhalten einen klaren Hinweis.
- Transcript, Score und Feedback werden im vorhandenen Lernstand gespeichert.
- CTC/Admin/Highscore/Teilnahmecode wurden nicht verändert.

Nächster sinnvoller Schritt:
- Phase 31: echte Geräteprüfung Mikrofon auf iPhone/Android/Desktop und Feinschliff der Aussprachebewertung.

---

## Phase 30C – A1-Sprechaufgaben parallel ausgebaut

Status: PASS

Ziel:
- Die Sprechaufgaben nicht nur technisch bereitstellen, sondern inhaltlich an den A1-Kursstand angleichen.
- Ab jetzt Kursinhalt und Sprechtraining nicht mehr getrennt entwickeln.

Umgesetzt:
- 40 neue `speaking_practice`-Aufgaben ergänzt.
- Jede der 10 A1-Lektionen besitzt jetzt 4 Sprechaufgaben.
- Jede Lektion steigt von 39 auf 43 Aufgaben.
- A1-Gesamtumfang steigt von 390 auf 430 Aufgaben.
- Deutsch/Türkisch-Zielsätze und Varianten ergänzt.
- Bestehender Phase-30B-Browser-Speech-Adapter bleibt erhalten.
- `LanguageAcademyCourseEntry.phase30SpeechSnapshot()` meldet jetzt A1-Coverage.
- Neue Projektregel ergänzt: Ab A2 werden normale Kursaufgaben und Sprechaufgaben parallel ausgebaut.

Neue Testdatei:
- `tests_phase30c_a1_speaking_content_expansion.html`

Aktualisierte Testdateien:
...
Ergebnis:
- Code-Syntaxchecks bestanden.
- Node-Mock-Diagnostics bestanden.
- A1-Sprechabdeckung vollständig: 10/10 Lektionen, je 4 Sprechaufgaben.

---

## Phase 30C-FIX – Mobile Speech Fix iPhone/iPad

Status: PASS nach Code-/Syntax-QA.

Auslöser:
- Nutzerfeedback: Sprechaufgabe funktioniert auf Desktop, aber nicht auf Handy/iPad.

Analyse:
- Web Speech Recognition ist auf mobilen Browsern und insbesondere iOS/iPadOS nur eingeschränkt verlässlich.
- In installierten iOS-PWAs/Home-Screen-Web-Apps kann SpeechRecognition ausfallen oder gar nicht verfügbar sein.
- Der bisherige Mikrofonbutton konnte bei `SpeechRecognition`-Unsupported-Zustand deaktiviert werden und dadurch auf mobilen Geräten wie „kaputt“ wirken.

Umgesetzt:
- `speechDeviceInfo()` ergänzt: erkennt iOS, Android, Touch-Geräte, Standalone/PWA und Secure Context.
- `speechRecognitionSupportStatus()` erweitert:
  - `supported`
  - `recognitionAvailable`
  - `mode: auto/mobile_fallback`
  - `ios_pwa_limited`
  - Geräteinformationen
- Mikrofonbutton bleibt jetzt auch im mobilen Fallback bedienbar.
- iPhone/iPad-Home-Screen-PWA wird sauber als eingeschränkt erkannt.
- Bei mobilem/unsupported Zustand wird ein mobiler Übungsmodus geöffnet statt die Aufgabe zu blockieren.
- iOS-Safe-Konfiguration für automatische Erkennung:
  - `interimResults=false`
  - `maxAlternatives=1`
- Desktop/Chrome behält 30B-Funktionen:
  - `interimResults=true`
  - `maxAlternatives=5`
- Fallback-Hinweis ergänzt: auf iPhone/iPad am besten direkt in Safari öffnen, nicht als Home-Screen-PWA.
- Teilnehmer kann Satz laut üben und über „Selbst nachgesprochen“ weiterarbeiten.

Neue Testdatei:
- `tests_phase30c_mobile_speech_fix.html`

Aktualisierte Testdatei:
- `tests_phase30b_browser_speech_upgrade.html`

Version:
- G54.11
- Cache: `egt-trainer-g54-11`
...
Offene Grenze:
- Echte Mikrofonerkennung muss weiterhin auf realen Geräten getestet werden.
- Automatische SpeechRecognition kann auf iOS/iPadOS je nach Browsermodus, Berechtigung, Siri-/Diktier-Einstellungen und PWA-Kontext limitiert bleiben.

## Phase 30D-FIX – iPhone/iPad HTTPS/Secure Speech Diagnostics

- Anlass: Desktop-Speech funktioniert, iPhone/iPad zeigte `unsupported` beim Test über `192.168.x.x`.
- Ursache: lokale IP/HTTP ist auf iOS/iPadOS für Web-Speech/Mikrofon kein zuverlässiger Secure Context.
- Umsetzung: `speechDeviceInfo()` erkennt Hostname, private IP und Secure Context.
- Umsetzung: `speechRecognitionSupportStatus()` liefert bei HTTP/lokaler IP `insecure_context` statt generischem `unsupported`.
- Umsetzung: Mikrofonprüfung zeigt Verbindung, Host und HTTPS-Hinweis.
- Unverändert: CTC, Admin, Highscore, Teilnahmecode, Firebase/Supabase.
