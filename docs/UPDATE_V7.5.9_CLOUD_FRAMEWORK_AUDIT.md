# Update V7.5.9 Cloud + Framework Audit Stable
...
3. Framework-/Core-Versionen waren sichtbar uneinheitlich zwischen V7.5.0/V7.5.8/V7.5.9.
...
- Runtime-/Cache-/Manifest-Version auf V7.5.9 angeglichen.
