...
2. Service Worker und Cache `egt-trainer-g54-49-0c` entfernen bzw. durch den vorherigen Cache ersetzen.
3. Prüfen, dass der klassische Gate-Screen wieder aktiv ist und Auth, Registrierung sowie Demo weiterhin funktionieren.

## Datenwirkung
G54.49.0D speichert keine Mood- oder Goal-Daten. Ein Rollback benötigt keine Datenmigration.
