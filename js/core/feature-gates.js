/* Eignungstest-Trainer V9.0.2 · Feature Gates
   Große Features werden bewusst freigeschaltet, statt unkontrolliert Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.FeatureGates && window.FeatureGates.__version === "9.0.2") return;
  ...
  window.FeatureGates = Object.freeze({__version:"9.0.2", isEnabled, set, merge, list});
})();
