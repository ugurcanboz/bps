/* Eignungstest-Trainer V7.6.0 · Feature Gates
   Große Features werden bewusst freigeschaltet, statt unkontrolliert Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.FeatureGates && window.FeatureGates.__version === "7.6.0") return;
  ...
  window.FeatureGates = Object.freeze({__version:"7.6.0", isEnabled, set, merge, list});
})();
