/* Eignungstest-Trainer V7.5.9 · Feature Gates
   Große Features werden bewusst freigeschaltet, statt unkontrolliert Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.FeatureGates && window.FeatureGates.__version === "7.5.9") return;
  ...
  window.FeatureGates = Object.freeze({__version:"7.5.9", isEnabled, set, merge, list});
})();
