...
(function(){
  ...
  var BRANCHES = Object.freeze({
    ...
    wissen: Object.freeze({
      ...
      tagHints: Object.freeze(['allgemeinwissen', 'mathe', 'logik', 'deutsch', 'englisch', 'konzentration', 'assessments', 'novuraExams'])
    })
  });
  ...
  function examTargetForMode(mode){
    ...
    if (selected === 'novuraExams' || selected === 'novuraExams') return 'novuraExams';
    if (selected === 'assessments') return 'assessments';
    return '';
  }
