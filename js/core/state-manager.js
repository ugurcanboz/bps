/* Eignungstest-Trainer V8.3.9 · Core State Manager
   Zentraler, kleiner App-Zustand für neue Features. Bestehende V8.3.9 Runtime bleibt unangetastet. */
(function(){
  "use strict";
  if(window.AppState && window.AppState.__version === "8.3.9") return;
  ...
  function load(){
    try{
      ...
      if(raw) state = Object.assign({}, defaults, JSON.parse(raw), {version:"8.3.9"});
  ...
  function set(patch, options){
    ...
    const before = get();
    state = Object.assign({}, state, patch, {version:"8.3.9"});
  ...
  load();
  window.AppState = Object.freeze({__version:"8.3.9", get, set, reset, load});
})();
