/* Eignungstest-Trainer V7.5.9 · Core State Manager
   Zentraler, kleiner App-Zustand für neue Features. Bestehende V7.5.9 Runtime bleibt unangetastet. */
(function(){
  "use strict";
  if(window.AppState && window.AppState.__version === "7.5.9") return;
  ...
  function load(){
    try{
      ...
      if(raw) state = Object.assign({}, defaults, JSON.parse(raw), {version:"7.5.9"});
  ...
  function set(patch, options){
    ...
    const before = get();
    state = Object.assign({}, state, patch, {version:"7.5.9"});
  ...
  load();
  window.AppState = Object.freeze({__version:"7.5.9", get, set, reset, load});
})();
