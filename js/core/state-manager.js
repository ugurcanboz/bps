/* Eignungstest-Trainer V7.5.0 · Core State Manager
   Zentraler, kleiner App-Zustand für neue Features. Bestehende V7.5.0 Runtime bleibt unangetastet. */
(function(){
  "use strict";
  if(window.AppState && window.AppState.__version === "7.5.0") return;
  ...
  function load(){
    try{
      ...
      if(raw) state = Object.assign({}, defaults, JSON.parse(raw), {version:"7.5.0"});
  ...
  function set(patch, options){
    ...
    const before = get();
    state = Object.assign({}, state, patch, {version:"7.5.0"});
  ...
  load();
  window.AppState = Object.freeze({__version:"7.5.0", get, set, reset, load});
})();
