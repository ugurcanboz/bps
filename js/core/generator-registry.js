...
(function () {
  ...
  var POOLS = Object.freeze({
    math: Object.freeze(['assessmentsMathTrainer']),
    ...
    assessments: Object.freeze(['analogy','series','symbolSeries','spatial','net','belt','arithmetic','fraction','percentReverse','area','dreisatz','bookGeneralKnowledge','knowledge','english','it','attention','codeCompare','focusScanner','symbolSearch','tableScan','visualJump','errorSearch','numberScan','tableComparePro','opinionFact','routeMemory','visualIQ']),
    novuraExams: Object.freeze(['novuraExamsMathSprint','bookTextMath','matrixBook','bookNumberSeries','bookVisualLogic','bookTextComprehension','series','matrix','gear','belt','arithmetic','percentReverse','fraction','dreisatz','attention','codeCompare','focusScanner','symbolSearch','tableScan','visualJump','errorSearch','numberScan','tableComparePro','statementLogic','spatial','analogy','english','it','opinionFact','fractionRuleEignungstest','tableCode','routeMemory','visualIQ']),
    ...
    mathSprint: Object.freeze(['novuraExamsMathSprint','bookTextMath','bookAlgebra','mul','div','percent','percentReverse','fraction','arithmetic','dreisatz','area']),
    ...
    errorTrainingPrep: Object.freeze(['matrixBook','novuraExamsMathSprint','series','matrix','focusScanner','tableComparePro','visualIQ','it','knowledge','routeMemory'])
  });
  ...
  function createAliasMap(generators) {
    var g = generators || {};
    return {
      assessmentsMathTrainer: g.assessmentsMathTrainer,
      ...
      novuraExamsMathSprint: g.novuraExamsMathSprint, bookTextMath: g.bookTextMath, bookAlgebra: g.bookAlgebra,
  ...
  function resolvePool(mode, options) {
    ...
    var branchEligible = (selectedMode === 'assessments' || selectedMode === 'jogging') && ['it','kaufm','sozial'].indexOf(branch) !== -1;
