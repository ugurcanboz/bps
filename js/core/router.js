/* Eignungstest-Trainer V8.3.9 · Hash Router Adapter
   Gibt neuen Modulen einen stabilen Router, ohne die alte App-Navigation zu zerstören. */
(function(){
  "use strict";
  if(window.AppRouter && window.AppRouter.__version === "8.3.9") return;
  ...
  window.AppRouter = Object.freeze({__version:"8.3.9", register, go, current});
})();
