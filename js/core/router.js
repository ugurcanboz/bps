/* Eignungstest-Trainer V9.0.2 · Hash Router Adapter
   Gibt neuen Modulen einen stabilen Router, ohne die alte App-Navigation zu zerstören. */
(function(){
  "use strict";
  if(window.AppRouter && window.AppRouter.__version === "9.0.2") return;
  ...
  window.AppRouter = Object.freeze({__version:"9.0.2", register, go, current});
})();
