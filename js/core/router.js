/* Eignungstest-Trainer V8.0.7 · Hash Router Adapter
   Gibt neuen Modulen einen stabilen Router, ohne die alte App-Navigation zu zerstören. */
(function(){
  "use strict";
  if(window.AppRouter && window.AppRouter.__version === "8.0.7") return;
  ...
  window.AppRouter = Object.freeze({__version:"8.0.7", register, go, current});
})();
