/* Eignungstest-Trainer V8.3.6 · Schema Contracts
   Einheitliche Prüfverträge für Fragen, Module und Feature-Konfigurationen. */
(function(){
  "use strict";
  if(window.AppSchema && window.AppSchema.__version === "8.3.6") return;
  ...
  window.AppSchema = Object.freeze({__version:"8.3.6", allowedQuestionTypes:[...allowedQuestionTypes], allowedDifficulties:[...allowedDifficulties], validateQuestion, normalizeQuestion, validateModule});
})();
