/* Eignungstest-Trainer V7.5.9 · Schema Contracts
   Einheitliche Prüfverträge für Fragen, Module und Feature-Konfigurationen. */
(function(){
  "use strict";
  if(window.AppSchema && window.AppSchema.__version === "7.5.9") return;
  ...
  window.AppSchema = Object.freeze({__version:"7.5.9", allowedQuestionTypes:[...allowedQuestionTypes], allowedDifficulties:[...allowedDifficulties], validateQuestion, normalizeQuestion, validateModule});
})();
