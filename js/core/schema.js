/* Eignungstest-Trainer.0.2 · Schema Contracts
   Einheitliche Prüfverträge für Fragen, Module und Feature-Konfigurationen. */
(function(){
  "use strict";
  if(window.AppSchema && window.AppSchema.__version === "9.0.2") return;
  const allowedQuestionTypes = new Set(["single","multiple","text","number","sequence","matrix","visual","memory","route","edv","logic","math"]);
  const allowedDifficulties = new Set(["leicht","mittel","schwer","novuraExams","bosch","assessments","adaptive"]);
  ...
  window.AppSchema = Object.freeze({__version:"9.0.2", allowedQuestionTypes:[...allowedQuestionTypes], allowedDifficulties:[...allowedDifficulties], validateQuestion, normalizeQuestion, validateModule});
})();
