/* Eignungstest-Trainer V7.6.0 · Schema Contracts
   Einheitliche Prüfverträge für Fragen, Module und Feature-Konfigurationen. */
(function(){
  "use strict";
  if(window.AppSchema && window.AppSchema.__version === "7.6.0") return;
  ...
  window.AppSchema = Object.freeze({__version:"7.6.0", allowedQuestionTypes:[...allowedQuestionTypes], allowedDifficulties:[...allowedDifficulties], validateQuestion, normalizeQuestion, validateModule});
})();
