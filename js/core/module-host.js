...
(function () {
  ...
  var BRANCHES = Object.freeze({
    ...
    kaufm: Object.freeze({
      ...
      icon: '💼',
      simulationMode: 'bps',
      simulationTitle: 'Kaufmännische BPS-Simulation',
      moduleId: 'sim-kaufm',
    ...
    sozial: Object.freeze({
      ...
      icon: '🤝',
      simulationMode: 'bps',
      simulationTitle: 'Sozialpädagogik BPS-Simulation',
      moduleId: 'sim-sozial',
  ...
  function simulationModeForBranch(branchId, preferredMode) {
    ...
    var mode = String(preferredMode || branch.simulationMode || 'ctcLohr');
    return mode;
  }
  ...
  function resolveQuestionProfile(branch, mode, opts) {
    ...
    return { branch: branch && branch.id ? branch.id : String(branch || 'it'), mode: mode || 'ctcLohr', poolKey: 'legacy', source: 'module-host-fallback' };
  }
