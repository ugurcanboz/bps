/* Eignungstest-Trainer V7.4.1 · Core Event Bus
   Minimal-invasiv: erweitert V7.4.1, ersetzt keine bestehende App-Logik. */
(function(){
  "use strict";
  if(window.AppEvents && window.AppEvents.__version === "7.4.1") return;
  ...
  window.AppEvents = Object.freeze({__version:"7.4.1", on, once, off, emit, clear});
})();
