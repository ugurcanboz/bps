/* Eignungstest-Trainer V7.5.9 · Core Event Bus
   Minimal-invasiv: erweitert V7.5.9, ersetzt keine bestehende App-Logik. */
(function(){
  "use strict";
  if(window.AppEvents && window.AppEvents.__version === "7.5.9") return;
  ...
  window.AppEvents = Object.freeze({__version:"7.5.9", on, once, off, emit, clear});
})();
