/* Eignungstest-Trainer V8.3.9 · Core Event Bus
   Minimal-invasiv: erweitert V8.3.9, ersetzt keine bestehende App-Logik. */
(function(){
  "use strict";
  if(window.AppEvents && window.AppEvents.__version === "8.3.9") return;
  ...
  window.AppEvents = Object.freeze({__version:"8.3.9", on, once, off, emit, clear});
})();
