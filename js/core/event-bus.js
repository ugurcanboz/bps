/* Eignungstest-Trainer V7.6.0 · Core Event Bus
   Minimal-invasiv: erweitert V7.6.0, ersetzt keine bestehende App-Logik. */
(function(){
  "use strict";
  if(window.AppEvents && window.AppEvents.__version === "7.6.0") return;
  ...
  window.AppEvents = Object.freeze({__version:"7.6.0", on, once, off, emit, clear});
})();
