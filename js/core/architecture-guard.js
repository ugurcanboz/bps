/* Eignungstest-Trainer V8.0.9 · Architecture Guard
   Prüft Core/State/Module/UI-Basis, ohne bestehende V7.3.1/V7.4.0-UI zu ersetzen. */
(function(){
  "use strict";
  if(window.ArchitectureGuard && window.ArchitectureGuard.__version === "8.0.9") return;
  const VERSION = "8.0.9";
  ...
  const REQUIRED_FILES = [
    "./css/app.css?v=8.0.9",
    "./css/mobile.css?v=8.0.9",
    "./css/ui-lock.css?v=8.0.9",
    "./js/core/app-config.js?v=8.0.9",
    "./js/core/event-bus.js?v=8.0.9",
    "./js/core/state-manager.js?v=8.0.9",
    "./js/core/router.js?v=8.0.9",
    "./js/core/schema.js?v=8.0.9",
    "./js/core/feature-gates.js?v=8.0.9",
    "./js/components/component-registry.js?v=8.0.9",
    "./js/module-registry.js?v=8.0.9",
    "./js/modules/module-loader.js?v=8.0.9"
  ];
