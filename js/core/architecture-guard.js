/* BPS-Trainer V7.5.0 · Architecture Guard
   Prüft Core/State/Module/UI-Basis, ohne bestehende V7.3.1/V7.4.0-UI zu ersetzen. */
(function(){
  "use strict";
  if(window.ArchitectureGuard) return;
  const VERSION = window.TRAINER_BUILD_VERSION || "7.5.8";
  ...
  const REQUIRED_FILES = [
    "./css/app.css?v=7.5.8",
    "./css/mobile.css?v=7.5.8",
    "./css/ui-lock.css?v=7.5.8",
    "./js/core/app-config.js?v=7.5.8",
    "./js/core/event-bus.js?v=7.5.8",
    "./js/core/state-manager.js?v=7.5.8",
    "./js/core/router.js?v=7.5.8",
    "./js/core/schema.js?v=7.5.8",
    "./js/core/feature-gates.js?v=7.5.8",
    "./js/components/component-registry.js?v=7.5.8",
    "./js/module-registry.js?v=7.5.8",
    "./js/modules/module-loader.js?v=7.5.8"
  ];
  ...
  function checkVersions(){
    ...
    return row("Core-Status", bad.length ? "warn" : "ok", versions.length ? (bad.length ? "uneinheitlich: " + "uneinheitlich" : "einheitlich") : "keine Versionen gefunden");
  }
  ...
  function checkRouting(){
    ...
    return row("Routing", hashSafe ? "ok" : "warn", hashSafe ? "Hash-Routing aktiv, 404-Fallback repariert" : "echte Unterseite erkannt");
  }
