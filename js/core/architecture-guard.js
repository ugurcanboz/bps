/* Eignungstest-Trainer V8.3.6 · Architecture Guard
   Prüft Core/State/Module/UI-Basis, ohne bestehende V7.3.1/V7.4.0-UI zu ersetzen. */
(function(){
  "use strict";
  if(window.ArchitectureGuard && window.ArchitectureGuard.__version === "8.3.6") return;
  const VERSION = "8.3.6";
  ...
  const REQUIRED_FILES = [
    "./css/app.css?v=8.3.6",
    "./css/mobile.css?v=8.3.6",
    "./css/ui-lock.css?v=8.3.6",
    "./js/core/app-config.js?v=8.3.6",
    "./js/core/event-bus.js?v=8.3.6",
    "./js/core/state-manager.js?v=8.3.6",
    "./js/core/router.js?v=8.3.6",
    "./js/core/schema.js?v=8.3.6",
    "./js/core/feature-gates.js?v=8.3.6",
    "./js/components/component-registry.js?v=8.3.6",
    "./js/module-registry.js?v=8.3.6",
    "./js/modules/module-loader.js?v=8.3.6"
  ];
