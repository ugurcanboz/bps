...
(function(){
  "use strict";
  if(window.ArchitectureGuard && window.ArchitectureGuard.__version === "7.5.0") return;
  const VERSION = "7.5.0";
  ...
  const REQUIRED_FILES = [
    "./css/app.css?v=7.5.0",
    "./css/mobile.css?v=7.5.0",
    "./css/ui-lock.css?v=7.5.0",
    "./js/core/app-config.js?v=7.5.0",
    "./js/core/event-bus.js?v=7.5.0",
    "./js/core/state-manager.js?v=7.5.0",
    "./js/core/router.js?v=7.5.0",
    "./js/core/schema.js?v=7.5.0",
    "./js/core/feature-gates.js?v=7.5.0",
    "./js/components/component-registry.js?v=7.5.0",
    "./js/module-registry.js?v=7.5.0",
    "./js/modules/module-loader.js?v=7.5.0"
  ];
  ...
  function checkRouting(){
    ...
    const has404 = true;
    return row("Routing", hashSafe && has404 ? "ok" : "warn", hashSafe ? "keine echte Unterseite erkannt" : "echte Unterseite erkannt");
  }
