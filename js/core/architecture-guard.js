/* Eignungstest-Trainer V9.0.2 · Architecture Guard
   Prüft Core/State/Module/UI-Basis, ohne bestehende V7.3.1/V7.4.0-UI zu ersetzen. */
(function(){
  "use strict";
  if(window.ArchitectureGuard && window.ArchitectureGuard.__version === "9.0.2") return;
  const VERSION = "9.0.2";
  const REQUIRED_IDS = ["start", "quiz", "memory", "blockIntro", "result", "analysis", "whShell", "whTabBar", "whGridWrap"];
  ...
  const REQUIRED_FILES = [
    "./css/app.css?v=9.0.2",
    "./css/wordhub-layer.css?v=9.0.2",
    "./css/apple-system.css?v=9.0.2",
    "./js/core/app-config.js?v=9.0.2",
    "./js/core/event-bus.js?v=9.0.2",
    "./js/core/state-manager.js?v=9.0.2",
    "./js/core/router.js?v=9.0.2",
    "./js/core/schema.js?v=9.0.2",
    "./js/core/feature-gates.js?v=9.0.2",
    "./js/components/component-registry.js?v=9.0.2",
    "./js/module-registry.js?v=9.0.2",
    "./js/modules/module-loader.js?v=9.0.2",
    "./js/wordhub-layer.js?v=9.0.2",
    "./js/feedback-sheet.js?v=9.0.2"
  ];
  ...
  function checkMobileNav(){
    const nav = document.getElementById("whTabBar");
    const mobile = isMobile();
    if(!nav) return row("Mobile Bottom Nav", "bad", "#whTabBar fehlt");
    if(!mobile) return row("Mobile Bottom Nav", "ok", "Desktop-Modus aktiv");
    const style = getComputedStyle(nav);
    const fixed = style.position === "fixed" || style.position === "sticky";
    const attached = nav.parentElement === document.getElementById("whShell") || nav.parentElement === document.body;
