/* Novura · Frontend Security Guard · G54.49.0H */
(function(root){
  'use strict';
  ...
  root.EGTDOMSecurity=Object.freeze({version:'G54.49.0H',escapeHTML:esc,sanitizeHTML:sanitizeHTML,safeUrl:safeUrl,setHTML:setHTML,appendHTML:appendHTML,setText:setText,debugAllowed:debugAllowed});
})(window);
