/* Novura · Frontend Security Guard · G54.50.2I */
(function(root){
  'use strict';
  ...
  root.EGTDOMSecurity=Object.freeze({version:'G54.50.2I',escapeHTML:esc,sanitizeHTML:sanitizeHTML,safeUrl:safeUrl,setHTML:setHTML,appendHTML:appendHTML,setText:setText,debugAllowed:debugAllowed});
})(window);
