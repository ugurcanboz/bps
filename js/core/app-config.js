...
(function () {
  'use strict';
  if (window.AppConfig && window.AppConfig.__version === 'G38.0-STABLE-2026-06-13') return;
  const VERSION = 'G38.0-STABLE-2026-06-13';
  ...
  window.AppConfig = Object.freeze({
    __version: VERSION, version: VERSION, build: 'G38.0-STABLE-2026-06-13',
