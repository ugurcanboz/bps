/* BPS-Trainer V9.0.1 · App Config */
(function () {
  'use strict';
  if (window.AppConfig && window.AppConfig.__version === '9.0.1') return;
  const VERSION = '9.0.1';
  const selectors = Object.freeze({
    appRoot: 'appRoot', start: 'start', appNav: 'appNav', healthPanel: 'healthPanel'
  });
  const paths = Object.freeze({
    styles: ['./css/app.css', './css/mobile.css', './css/ui-lock.css', './css/wordhub-layer.css'],
  ...
  window.AppConfig = Object.freeze({
    __version: VERSION, version: VERSION, build: 'v900',
