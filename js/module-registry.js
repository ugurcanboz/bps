/* Eignungstest-Trainer V7.5.0 · Module Registry
   Neue Features werden hier registriert, statt Core/UI direkt zu verändern. */
(function(){
  "use strict";
  const modules = new Map();
  const state = Object.seal({version:"7.5.0", lockedUi:true, started:false, initialized:[]});
  ...
  window.TrainerModules = Object.freeze({__version:"7.5.0", register, get, list, initAll, state});
})();
