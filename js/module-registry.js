/* Eignungstest-Trainer V8.3.9 · Module Registry
   Neue Features werden hier registriert, statt Core/UI direkt zu verändern. */
(function(){
  "use strict";
  const modules = new Map();
  const state = Object.seal({version:"8.3.9", lockedUi:true, started:false, initialized:[]});
  ...
  window.TrainerModules = Object.freeze({__version:"8.3.9", register, get, list, initAll, state});
})();
