/* Eignungstest-Trainer.0.2 · Module Registry
   Neue Features werden hier registriert, statt Core/UI direkt zu verändern. */
(function(){
  "use strict";
  const modules = new Map();
  const state = Object.seal({version:"internal", lockedUi:true, started:false, initialized:[]});
  ...
  function register(name, definition){
    ...
    const safeDefinition = Object.assign({name, enabled:true, version:"internal", description:""}, definition || {});
  ...
  window.TrainerModules = Object.freeze({__version:"internal", register, get, list, initAll, state});
})();
