/* Eignungstest-Trainer V7.4.1 · Module Registry
   Neue Features werden hier registriert, statt Core/UI direkt zu verändern. */
(function(){
  "use strict";
  const modules = new Map();
  const state = Object.seal({version:"7.4.1", lockedUi:true, started:false, initialized:[]});
  ...
  window.TrainerModules = Object.freeze({register, get, list, initAll, state});
})();
