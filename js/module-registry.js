/* Eignungstest-Trainer V8.0.8 · Module Registry
   Neue Features werden hier registriert, statt Core/UI direkt zu verändern. */
(function(){
  "use strict";
  const modules = new Map();
  const state = Object.seal({version:"8.0.8", lockedUi:true, started:false, initialized:[]});
  ...
  window.TrainerModules = Object.freeze({__version:"8.0.8", register, get, list, initAll, state});
})();
