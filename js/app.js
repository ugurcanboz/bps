...
/* Question Factory, Group Mapping, EDV-Schema, Generatoren, Route- und EDV-Fragenaufbau. */
  ...
  const Generators = {
    ...
    visualTechnical(level) {
      ...
      else if(scenario==="drive"){q="Welche Scheibe dreht sich am schnellsten?"; correct="die kleinste Scheibe"; ex="Bei gleicher Riemengeschwindigkeit dreht die kleinste Scheibe am schnellsten.";}
      else if(scenario==="lever"){q="Wo muss die Kraft ansetzen, damit der Hebel am wenigsten Kraft braucht?"; correct="am Ende des langen Arms"; ex="Je länger der Kraftarm, desto weniger Kraft wird benötigt (Hebelgesetz).";}
      else if(scenario==="gearRatio"){q="Ein großes Zahnrad (24 Zähne) treibt ein kleines (8 Zähne) an. Wie oft dreht das kleine Rad pro Umdrehung des großen?"; correct="3 mal"; ex="Übersetzungsverhältnis: 24:8 = 3. Das kleine Rad dreht dreimal schneller.";}
      else if(scenario==="incline"){q="Eine Kiste soll auf eine Rampe geschoben werden. Welche Rampe erfordert am wenigsten Kraft?"; correct="die flachste (längste) Rampe"; ex="Längere, flachere Rampen brauchen weniger Kraft – die Wegstrecke wird geteilt.";}
      else {q="Welches Prinzip ermöglicht es, schwere Lasten mit wenig Kraft zu heben?"; correct="Flaschenzug"; ex="Ein Flaschenzug multipliziert die Kraft durch Umlenkung der Seile.";}
      const distractors={pressure:["oben an der Oberfläche","Bauteil A","nicht bestimmbar"],support:["Rechteckkonstruktion","Bauteil A","nicht bestimmbar"],block:["Bauteil A","Bauteil B","nicht bestimmbar"],drive:["Bauteil A","Bauteil B","nicht bestimmbar"],lever:["in der Mitte","am Ende des kurzen Arms","nicht bestimmbar"],gearRatio:["1 mal","2 mal","4 mal"],incline:["die steilste (kürzeste) Rampe","eine Rampe mit 45°","alle Rampen erfordern gleich viel Kraft"],pulley:["Schraube","Rampe","Nicht bestimmbar"]};
