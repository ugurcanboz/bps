...
window.App = (() => {
  ...
  const APP_VERSION = "9.5.8-phase-c-premium-ux-polish";
...
/* Question Factory, Group Mapping, EDV-Schema, Generatoren, Route- und EDV-Fragenaufbau. */
  ...
  function stableSignature(q) {
    return [q.cat,q.q,q.type,JSON.stringify(q.grid||q.series||q.symbols||q.visual||q.tableRows||q.schemaRows||q.fraction||q.fractionRule||q.routeStreets||q.signatureSeed||{})].join("|");
  }
