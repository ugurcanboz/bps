/* Eignungstest-Trainer.3.0 · Learning Coach V2 Premium UI
...
(function(){
  ...
  function notice(text){ try{ if(window.EGTWordHubLayer && typeof EGTWordHubLayer.notice === 'function') return EGTWordHubLayer.notice(text); }catch(e){} if(CONFIG.debug) console.log('[Coach]', text); }
  ...
  function renderHub(){
    ...
    return ''+
      '<section class="bps-coach-hero">'+
        '<div><span class="bps-coach-kicker">Coach  · Premium UX Polish</span><h2>Dein Coach führt die nächste sinnvolle Runde.</h2><p>Kurze Diagnose, klare Empfehlung, gezielte Revanche. Öffne ◈ für Readiness, Lernpfad und Prüfungsampel.</p></div>'+
  ...
  function injectCoachCard(){
    ...
    card.innerHTML = '<div class="wh-mod-icon c-blue">✦</div><span class="wh-mod-label">KI Coach </span><small class="wh-mod-sub">adaptiv</small>';
