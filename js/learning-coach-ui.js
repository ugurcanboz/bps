...
(function(){
  ...
  function renderHub(){
    ...
    return ''+
      ...
      '</section>'+
      renderPulse(s)+renderDatabasePulse(db)+renderUserDatabaseCoachCard()+
  ...
  function openHub(){ messages = messages.slice(-6); open('KI Coach ', 'menschlicher · stabiler · prüfungsnah', renderHub(), { pauseTimer: quizVisible() }); }
