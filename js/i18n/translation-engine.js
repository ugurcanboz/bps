...
(function(){
  ...
  var VERSION = 'G54.43.9K-translation-engine';
  ...
  var embedded = {
    de: {
      ...
      'language.de':'Deutsch','language.tr':'Türkisch','language.en':'Englisch','course.a1.title':'Deutsch A1',
    ...
    tr: {
      ...
      'language.de':'Almanca','language.tr':'Türkçe','language.en':'İngilizce','course.a1.title':'Almanca A1',
  ...
  function normalizeLang(lang){ lang = String(lang || '').trim().toLowerCase(); return (lang === 'tr' || lang === 'de' || lang === 'en') ? lang : 'de'; }
  ...
  register('en', Object.assign({}, embedded.de, {'language.de':'German','language.tr':'Turkish','language.en':'English','course.dashboard.title':'Language training','course.dashboard.subtitle':'Learn step by step at your level.','help.default':'Help explains the task, but never shows the direct solution.'}));
