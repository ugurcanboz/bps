/* ════════════════════════════════════════════════════════════════
   egt-sim-sozial.js — Phase 6 branchenspezifisches Simulationsmodul
   Zweck: Sozialpädagogik bekommt einen eigenen ModuleHost-Einstieg. Die fachliche
...
(function () {
  ...
  var MODULE_ID = 'sim-sozial';
  var BRANCH_ID = 'sozial';
  var LABEL = 'Sozialpädagogik';
  var MODE = 'assessments';
  var SOURCE = 'phase5-sim-sozial';
  var TAG_HINTS = ["sozial", "paedagogik", "pädagogik", "entwicklung", "bindung", "dokumentation"];
  ...
  function buildConfig(payload) {
    ...
    return {
      ...
      title: payload.title || 'Sozialpädagogische Novura Assessments',
  ...
  if (window.AppModuleHost && typeof AppModuleHost.register === 'function') {
    ...
    console.warn('[EGTSimSozialModule] AppModuleHost fehlt; Registrierung übersprungen.');
  }
})();
