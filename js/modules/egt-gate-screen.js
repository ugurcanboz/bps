...
(function () {
  ...
  function buildScreen(reason) {
    return (
      ...
      '<div class="egt-gate-top">' +
        ...
        '<span class="brand"><b>Novura</b><small>One day, you\'ll thank today.</small></span>' +
  ...
  function showGate(reason) {
    if (window.NovuraGuidedWelcomeUI && typeof window.NovuraGuidedWelcomeUI.show === 'function') {
      window.NovuraGuidedWelcomeUI.show({ reason: reason || '', onAuth: function(action){ openSheet(action); } });
      return;
    }
    if (screenEl) return;
  ...
  function closeGate() {
    if (window.NovuraGuidedWelcomeUI && window.NovuraGuidedWelcomeUI.isOpen && window.NovuraGuidedWelcomeUI.isOpen()) {
      window.NovuraGuidedWelcomeUI.close();
    }
    if (!screenEl) return;
  ...
  window.EGTGateScreen = Object.assign(window.EGTGateScreen||{}, {
    show: showGate, close: closeGate, openSheet: openSheet, toggleMute: toggleMute
  });
