    ...
    const engine = {
        ...
        renderActionGrid(summary={}) {
          return `<section class="hs-action-grid" aria-label="Highscore Aktionen">
            ...
            <button type="button" class="hs-action-card" data-action="hs-duel-info" data-duel="random"><span>${this.icon("crosshair")}</span><b>Zufälliges Duell</b><small>Simulation-Duell wird vorbereitet</small></button>
            <button type="button" class="hs-action-card" data-action="hs-duel-info" data-duel="friends"><span>${this.icon("users")}</span><b>Freunde fordern</b><small>Teilnehmerauswahl im Profil-Upgrade</small></button>
          ...
          return `<div class="hs-arena-inner ${options.error?"is-error":(loading?"is-loading":"is-live")}">
            ...
            <div class="hs-grid">
              ...
              <aside class="hs-side-column">
                ...
                ${this.renderDuelPreview(summary)}
