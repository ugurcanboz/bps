...
const defaults = {
  duration: 24000,
  brand: { name: 'Eignungstest-Trainer', tagline: 'Dein persönlicher Trainingsbereich' },
  keepOpen: false,
  tiles: [
...
function mountCinematicIntro(target, opts = {}) {
  ...
  apply(0);
  play();
  return { close, replay, pause, resume, toEnd, seek, el: root, duration: TOTAL };
}
