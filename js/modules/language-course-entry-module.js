...
(function(){
  ...
  function openDashboard(){
    ...
    var body='<div class="la-dashboard la-dashboard-phase24c" data-la-dashboard="phase26c">'+
      ...
      '</section>'+ 
      '<section class="la-card la-current-course"><div><span class="la-section-kicker">Aktueller Kurs</span><h3>'+esc(cc.course)+' '+esc(cc.level)+'</h3><p>Lektion: <b>'+esc(cc.lesson)+'</b></p><span class="la-progress"><i style="width:'+esc(cc.progress)+'%"></i></span><small>'+esc(cc.progress)+' % Fortschritt · '+esc(cc.lastAction)+'</small></div><button type="button" class="la-primary" data-ui-action="language-course-continue">Weiterlernen</button></section>'+       (window.LanguageExamShell&&typeof window.LanguageExamShell.summaryCardHtml==='function'?window.LanguageExamShell.summaryCardHtml():'<section class="la-card la-exam-entry-card"><span class="la-section-kicker">Prüfungssimulation</span><h3>Harte Prüfung A1 bis C2</h3><p class="la-note">Prüfungsmodus wird geladen.</p><div class="la-level-actions"><button type="button" class="la-primary" data-ui-action="language-exam-open">Prüfungssimulation öffnen</button></div></section>')+       '<section class="la-card la-placement-card"><span class="la-section-kicker">Einstufungstest</span><h3>Sprachtest A1 bis C2</h3><p>Simulierter Testmodus mit Timer, gemischten Aufgaben und Ergebnisniveau. Der Test ersetzt kein offizielles Zertifikat, gibt aber eine klare Lernempfehlung.</p><div class="la-level-actions"><button type="button" class="la-primary" data-ui-action="language-course-placement-test">Einstufungstest starten</button></div></section>'+ 
