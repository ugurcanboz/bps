/* ════════════════════════════════════════════════════════════════
   egt-sim-it.js — Phase 6 branchenspezifisches Simulationsmodul
   Zweck: IT / FISI bekommt einen eigenen ModuleHost-Einstieg. Die fachliche
...
(function () {
  ...
  var MODULE_ID = 'sim-it';
  var BRANCH_ID = 'it';
  var LABEL = 'IT / FISI';
  var MODE = 'novuraExams';
  var SOURCE = 'phase5-sim-it';
  var TAG_HINTS = ["it", "fisi", "netzwerk", "hardware", "security", "osi"];
  ...
  function buildConfig(payload) {
    ...
    return {
      ...
      title: payload.title || 'IT/FISI Eignungstest-Simulation',
  ...
  if (window.AppModuleHost && typeof AppModuleHost.register === 'function') {
    ...
    console.warn('[EGTSimITModule] AppModuleHost fehlt; Registrierung übersprungen.');
  }
})();
