/* Eignungstest-Trainer V9.0.2 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "9.0.2") return;
  ...
  window.AppModuleLoader = Object.freeze({__version:"9.0.2", register, initAll, list});
})();
