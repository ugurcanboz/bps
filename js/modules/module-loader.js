/* Eignungstest-Trainer V7.4.1 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "7.4.1") return;
  ...
  window.AppModuleLoader = Object.freeze({__version:"7.4.1", register, initAll, list});
})();
