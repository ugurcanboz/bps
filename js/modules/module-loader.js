/* Eignungstest-Trainer V7.5.0 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "7.5.0") return;
  ...
  function register(definition){
    ...
    modules.set(id, Object.assign({enabled:true, version:"0.0.0", init:null, destroy:null}, definition));
    if(window.AppState){
      const status = window.AppState.get("moduleStatus") || {};
      status[id] = {registered:true, enabled:definition.enabled !== false, version:definition.version || "0.0.0"};
  ...
  window.AppModuleLoader = Object.freeze({__version:"7.5.0", register, initAll, list});
})();
