/* Eignungstest-Trainer V7.6.0 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "7.6.0") return;
  ...
  window.AppModuleLoader = Object.freeze({__version:"7.6.0", register, initAll, list});
})();
