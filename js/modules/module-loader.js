/* Eignungstest-Trainer V8.0.7 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "8.0.7") return;
  ...
  window.AppModuleLoader = Object.freeze({__version:"8.0.7", register, initAll, list});
})();
