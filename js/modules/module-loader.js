/* Eignungstest-Trainer V7.5.9 · Module Loader
   Module docken künftig hier an, statt direkt Core/UI zu verändern. */
(function(){
  "use strict";
  if(window.AppModuleLoader && window.AppModuleLoader.__version === "7.5.9") return;
  ...
  window.AppModuleLoader = Object.freeze({__version:"7.5.9", register, initAll, list});
})();
