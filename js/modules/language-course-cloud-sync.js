/* Language Academy · Phase 28
   Cloud-Sync-Adapter für Sprachkursfortschritt.
   Ziel: cloudfähig ohne Highscore/Admin/CTC zu verändern.
*/
(function(){
  'use strict';
  ...
  statusPatch({ok:!!localRemote(), lastError:localRemote()?'':'Cloud-Sync bereit · noch kein Sprachkursstand gespiegelt'});
})();
