/* Eignungstest-Trainer V8.0.9 · Component Registry
   Zentrale UI-Bausteine für künftige Features. Bestehende HTML-Struktur bleibt geschützt. */
(function(){
  "use strict";
  if(window.AppComponents && window.AppComponents.__version === "8.0.9") return;
  ...
  window.AppComponents = Object.freeze({__version:"8.0.9", register, render, names});
})();
