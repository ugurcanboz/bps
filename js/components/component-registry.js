/* Eignungstest-Trainer V7.5.0 · Component Registry
   Zentrale UI-Bausteine für künftige Features. Bestehende HTML-Struktur bleibt geschützt. */
(function(){
  "use strict";
  if(window.AppComponents && window.AppComponents.__version === "7.5.0") return;
  ...
  window.AppComponents = Object.freeze({__version:"7.5.0", register, render, names});
})();
