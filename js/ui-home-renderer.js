...
(function () {
    ...
    return '' +
      '<div class="product-flow product-flow-simulation">' +
        '<div class="ui-deep-benefits product-rules">' +
          ...
          '<div class="ui-deep-benefit"><b>Auswahltest</b><span>BPS · CTC · Berufsfeld</span></div>' +
        '</div>' +
        '<div class="product-warning"><b>Eignungstest-Simulation:</b> BPS, CTC und berufliche Auswahltests laufen ohne Hilfe, ohne Sofortfeedback und ohne Coach während der Aufgabe. Sprachtests sind separat auf der Home-Seite erreichbar.</div>' +
  ...
  function openSimulationCenterDeepSheet() {
    return openDeepSheet({
      ...
      theme: 'indigo',
      title: 'Eignungstest-Simulation',
      kicker: 'Prüfungsmodus',
      subtitle: 'BPS, CTC und berufliche Auswahltests. Sprachtest-Simulation ist als eigener Einstieg getrennt.',
        ...
        '<main class="ui-home-scroll" id="uiHomeViewport">' +
          '<section class="ui-hero-ui product-home-hero" aria-label="Simulation starten">' +
            '<div class="ui-hero-copy">' +
              ...
              '<p>Starte entweder Eignungstests oder Sprachtest-Vollprüfungen. Training, Coach und Analyse helfen dir danach gezielt weiter.</p>' +
              '<button class="ui-hero-cta" type="button" data-ui-action="simulation-center"><span class="ui-inline-icon">' + iconSvg('target', 'ui-inline-icon-svg') + '</span>Eignungstest starten</button>' +
            '</div>' +
          ...
          '<section class="ui-sim-hero" aria-label="Eignungstest Simulation">' +
            '<button type="button" class="ui-sim-hero-card ui-sim-exam-hero-card" data-ui-action="simulation-center">' +
              ...
              '<span class="ui-sim-hero-copy">' +
                ...
                '<small>BPS, CTC und berufliche Auswahltests realistisch starten. Keine Hilfe im Test, Auswertung und KI-Coach erst danach.</small>' +
              '</span>' +
              '<span class="ui-sim-hero-cta">Eignungstest öffnen ›</span>' +
            '</button>' +
          '</section>' +
          ...
          '<section class="ui-training-area-grid" aria-label="Trainingsbereich wählen">' +
            ...
            '<button type="button" class="ui-training-area-card ui-area-individual language-course-hero-card" data-ui-action="language-course-open">' +
              '<span class="ui-area-icon">' + iconSvg('language') + '</span><b>Sprachtraining</b><small>Üben mit Hilfssprache · A1–C2 Lernpfad</small>' +
            '</button>' +
          ...
          '<section class="ui-quick-grid product-recommend-grid" aria-label="Heute empfohlen">' +
            '<button type="button" class="ui-quick-card ui-area-it" data-ui-action="simulation-center"><span class="ui-quick-icon">' + iconSvg('target') + '</span><b>Eignungstest</b><small>BPS / CTC</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-social" data-ui-action="language-test-simulation-open"><span class="ui-quick-icon">' + iconSvg('language') + '</span><b>Sprachtest</b><small>Deutsch Vollprüfung</small></button>' +
