      ...
      '<div class="ui-home">' +
        '<header class="ui-header">' +
          ...
          '<div class="ui-topbar-chips">' +
            ...
            '<button class="ui-login-btn" id="uiLoginBtn" aria-label="Login" data-ui-action="auth-open">Login</button>' +
          '</div>' +
        '</header>' +
        ...
        '<main class="ui-home-scroll" id="uiHomeViewport">' +
          ...
          '<section class="up-auth-slot" id="upAuthGateSlot" aria-label="Login, Zugang und Profil"></section>' +
          ...
          '<section class="ui-quick-grid" aria-label="Schnellzugriff">' +
            ...
            '<button type="button" class="ui-quick-card ui-area-knowledge" data-ui-action="profile-open"><span class="ui-quick-icon"><img src="./assets/ui/icon-user.svg" alt=""></span><b>Profil</b><small>Konto & Zugang</small></button>' +
