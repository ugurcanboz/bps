      ...
      '<div class="product-flow product-flow-simulation">' +
        ...
        '<div class="product-track-grid">' +
          ...
          '<section class="product-track-card product-track-kaufm">' +
            ...
            '</div>' +
          '</section>' +
          '<section class="product-track-card product-track-language" data-simulation-track="language">' +
            '<div class="product-track-head"><span>' + iconSvg('language') + '</span><div><b>Sprachtest-Simulation</b><small>Deutsch · Vollprüfung</small></div></div>' +
            '<div class="product-sim-options">' +
              '<button type="button" class="ui-deep-card product-sim-choice product-sim-language-choice" data-ui-action="language-test-simulation-open" data-language="de">' +
                '<span class="ui-deep-card-icon">' + iconSvg('language') + '</span>' +
                '<span class="ui-deep-card-copy"><b>Sprachtest-Simulation · Deutsch</b><small>Immer Vollprüfung: Lesen, Hören, Grammatik, Schreiben und Sprechen. Keine Hilfe während der Simulation.</small></span>' +
                '<span class="ui-deep-card-arrow" aria-hidden="true">›</span>' +
              '</button>' +
            '</div>' +
          '</section>' +
        ...
        '<main class="ui-home-scroll" id="uiHomeViewport">' +
          '<section class="ui-hero-ui product-home-hero" aria-label="Simulation starten">' +
            '<div class="ui-hero-copy">' +
              ...
              '<p>Starte prüfungsnahe BPS-, CTC- oder Sprachtest-Simulationen. Training, Coach und Analyse helfen dir danach gezielt weiter.</p>' +
          ...
          '<section class="ui-sim-hero" aria-label="Eignungstest Simulation">' +
            '<button type="button" class="ui-sim-hero-card" data-ui-action="simulation-center">' +
              ...
              '<span class="ui-sim-hero-copy">' +
                ...
                '<small>Bereich wählen, BPS, CTC oder Sprachtest-Vollprüfung starten, keine Hilfe im Test, Auswertung und KI-Coach erst danach.</small>' +
              '</span>' +
