...
(function () {
  ...
  var VERSION = 'G54.0-phase26-product-navigation-structure';
      ...
      '<div class="product-flow product-flow-simulation">' +
        ...
        '<div class="product-track-grid">' +
          '<section class="product-track-card product-track-it">' +
            '<div class="product-track-head"><span>💻</span><div><b>IT / FISI</b><small>BPS oder CTC</small></div></div>' +
            '<div class="product-sim-options">' +
              simulationProfileCard('it', 'bps', 'BPS-Simulation', 'IT-passender Aufgabenmix', '🎯') +
              simulationProfileCard('it', 'ctc', 'CTC-Lohr Simulation', 'Allgemeinwissen, Mathe, Regelrechnung, Konzentration, Tabellen und Wenn-Dann-Ablauf', '⚡') +
            '</div>' +
          '</section>' +
          '<section class="product-track-card product-track-social">' +
            '<div class="product-track-head"><span>🤝</span><div><b>Sozialpädagogik</b><small>BPS ohne IT-Fragen</small></div></div>' +
            '<div class="product-sim-options">' +
              simulationProfileCard('sozial', 'bps', 'BPS-Simulation', 'pädagogiknahe Mischung ohne IT-Fragen', '🎯') +
            '</div>' +
          '</section>' +
          '<section class="product-track-card product-track-kaufm">' +
            '<div class="product-track-head"><span>💼</span><div><b>Kaufmännisch</b><small>BPS mit kaufmännischem Fokus</small></div></div>' +
            '<div class="product-sim-options">' +
              simulationProfileCard('kaufm', 'bps', 'BPS-Simulation', 'kaufmännisch passender Aufgabenmix', '🎯') +
            '</div>' +
          '</section>' +
        '</div>' +
      '</div>';
  ...
  function openBranchTrainingDeepSheet(branchId) {
    ...
    return openDeepSheet({
      ...
      iconHtml: branchId === 'sozial' ? '🤝' : (branchId === 'kaufm' ? '💼' : '💻'),
    ...
    return '' +
      '<div class="product-flow product-flow-training">' +
        ...
        '<div class="ui-deep-grid product-training-grid">' +
          trainingCategoryCard('branch-training', 'IT / FISI Training', 'Kategorien wählen: IT, Mathe, Logik, Python, Englisch, Deutsch, Technik.', '💻', 'data-branch="it"') +
          trainingCategoryCard('branch-training', 'Sozialpädagogik Training', 'Keine IT-Fragen: Mathe, Deutsch, Englisch, Pädagogik, Situationen, Textverständnis.', '🤝', 'data-branch="sozial"') +
          trainingCategoryCard('branch-training', 'Kaufmännisches Training', 'Prozent, Dreisatz, Deutsch, Englisch, Tabellenverständnis, Wirtschaft, Logik.', '💼', 'data-branch="kaufm"') +
        '</div>' +
        '<div class="ui-deep-section-label">Einzeltraining</div>' +
        '<div class="ui-deep-grid product-single-grid">' +
          trainingCategoryCard('single-training', 'Mathe', 'Kopfrechnen, Prozent, Dreisatz, Brüche und Textaufgaben.', '➗', 'data-mode="math"') +
          trainingCategoryCard('single-training', 'Deutsch', 'Satzergänzung, Sprache und Textverständnis.', '✏️', 'data-mode="sentenceSprint"') +
          trainingCategoryCard('single-training', 'Englisch', 'Vokabeln, Grammatik und Basics.', '🗣', 'data-mode="english"') +
          trainingCategoryCard('single-training', 'Logik', 'Zahlenreihen, Muster, Aussagenlogik.', '🧩', 'data-mode="logic"') +
          trainingCategoryCard('single-training', 'Matrizen', 'Mustersehen und visuelle Beziehungen.', '▦', 'data-mode="matrixOnlySprint"') +
          trainingCategoryCard('single-training', 'Allgemeinwissen', 'Politik, Geschichte, Geografie, Alltag.', '🌐', 'data-mode="general"') +
          trainingCategoryCard('single-training', 'Technisches Verständnis', 'Mechanik, Technik, Visual IQ.', '⚙️', 'data-mode="techniqueSprint"') +
          trainingCategoryCard('python-quest', 'Python-Kurs', 'Levelsystem, Übungen, Zwischen- und Abschlussprüfung.', '🐍') +
        '</div>' +
        '<div class="ui-deep-startbox">' +
  ...
  function openMoreDeepSheet() {
    var body = '' +
      ...
      '<div class="ui-deep-grid product-more-grid">' +
        actionCardHtml('auth-open', 'Profil', 'Login, Zugangscode, Demo und Benutzerprofil', '👤') +
        actionCardHtml('settings', 'Einstellungen', 'System, Cache, Daten und App-Optionen', '⚙️') +
        actionCardHtml('highscore-sheet', 'Highscore', 'Ranking, Zeitraum, Cloud und lokale Liste', '🏆') +
        actionCardHtml('duel-hub', 'Duell', 'Challenge, Verlauf und Wettkampf', '⚔️') +
        actionCardHtml('admin-open', 'Admin / Dozent', 'Teilnehmer, Gruppen, Codes und Auswertung', '♙') +
        actionCardHtml('feedback', 'Feedback / Hilfe', 'Fehler melden oder Verbesserung notieren', '✉') +
      '</div>';
    return openDeepSheet({ type:'more-menu', theme:'slate', title:'Mehr', kicker:'System', subtitle:'Alles Wichtige, das nicht dauerhaft in die Hauptnavigation gehört.', iconHtml:'•••', bodyHtml:body });
  }
  ...
  function openSettingsDeepSheet() {
    var body =
      ...
      '<div class="ui-deep-grid">' +
        actionCardHtml('auth-open', 'Login & Profil', 'Zugangscode, Demo, Profil und UserDatabase öffnen', '👤') +
        actionCardHtml('login-open-core', 'Admin-Portal öffnen', 'Bestehendes Teilnehmer-, Dozenten- oder Adminportal', '♙') +
  ...
  function openLoginDeepSheet() {
    var body =
      '<div class="ui-deep-grid">' +
        actionCardHtml('auth-login', 'Login', 'Mit bestehendem Teilnehmercode anmelden', '🔐') +
        ...
        actionCardHtml('login-open-core', 'Admin-Portal', 'Bestehendes Admin-/Dozentenportal öffnen', '⚙') +
  ...
  function navIcon (name) {
    var paths = {
      ...
      swords: '<path d="M14 4l6 6"/><path d="m15 9-7 7-3 1 1-3 7-7"/><path d="M10 4l10 10"/><path d="M4 20l6-6"/><path d="M4 4l16 16"/>',
  ...
  function renderHighscoreTab (el) {
    ...
    el.innerHTML =
      '<div class="ui-analysis-wrap ui-highscore-page">' +
        '<div class="ui-section-title">🏆 Highscore</div>' +
  ...
  function renderDuelsTab (el) {
    ...
    var html =
      '<div class="ui-analysis-wrap ui-duel-page">' +
        '<div class="ui-section-title">⚔️ Duelle</div>' +
  ...
  function renderProfileTab (el) {
    el.innerHTML =
      '<div class="ui-analysis-wrap ui-profile-page">' +
        '<div class="ui-section-title">👤 Profil</div>' +
        ...
        '<main class="ui-home-scroll" id="uiHomeViewport">' +
          '<section class="ui-hero-ui product-home-hero" aria-label="Simulation starten">' +
            '<div class="ui-hero-copy">' +
              ...
              '<button class="ui-hero-cta" type="button" data-ui-action="simulation-center">Simulation starten 🎯</button>' +
            '</div>' +
          ...
          '<section class="ui-sim-hero" aria-label="Eignungstest Simulation">' +
            '<button type="button" class="ui-sim-hero-card" data-ui-action="simulation-center">' +
              '<span class="ui-sim-hero-icon" aria-hidden="true">🎯</span>' +
          ...
          '<section class="ui-training-area-grid" aria-label="Trainingsbereich wählen">' +
            ...
            '<button type="button" class="ui-training-area-card ui-area-individual language-course-hero-card" data-ui-action="language-course-open">' +
              '<span class="ui-area-icon">🌍</span><b>Sprachkurs</b><small>Deutsch/Türkisch · A1–C2 vorbereitet</small>' +
            '</button>' +
          ...
          '<section class="ui-quick-grid product-recommend-grid" aria-label="Heute empfohlen">' +
            '<button type="button" class="ui-quick-card ui-area-it" data-ui-action="simulation-center"><span class="ui-quick-icon">🎯</span><b>BPS/CTC wählen</b><small>Simulation Center</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-social" data-ui-action="training-center"><span class="ui-quick-icon"><img src="./assets/ui/icon-practice.svg" alt=""></span><b>Gezielt trainieren</b><small>Berufsfeld oder Einzeltraining</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-knowledge" data-ui-action="analysis"><span class="ui-quick-icon"><img src="./assets/ui/icon-analysis.svg" alt=""></span><b>Prüfungsreife</b><small>Analyse & Fortschritt</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-individual" data-ui-action="coach"><span class="ui-quick-icon"><img src="./assets/ui/icon-coach.svg" alt=""></span><b>KI-Coach</b><small>Empfehlung & Erklärung</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-it" data-ui-action="python-quest"><span class="ui-quick-icon">🐍</span><b>Python fortsetzen</b><small>Levelsystem</small></button>' +
            '<button type="button" class="ui-quick-card language-course-hero-card" data-ui-action="language-course-open"><span class="ui-quick-icon">🌍</span><b>Sprachkurs</b><small>Deutsch/Türkisch öffnen</small></button>' +
            '<button type="button" class="ui-quick-card ui-area-social" data-ui-action="more-menu"><span class="ui-quick-icon">•••</span><b>Mehr</b><small>Profil, Highscore, Duell, Admin</small></button>' +
          '</section>' +
  ...
  function openDuelSheet () {
    ...
    var duels = (data && data.duels) || [];
    var body =
      '<div class="ui-deep-section-label">⚔️ Duell-Zentrale</div>' +
      '<div class="ui-action-card-grid ui-g37-duel-actions">' +
    ...
    return openDeepSheet({
      ...
      subtitle: 'Separater Bereich für Challenge, Verlauf und direkte Duellstarts.', iconHtml: '⚔️',
      bodyHtml: body
    });
  }
  ...
  function openHighscoreSheet () {
    ...
    body += '<div class="ui-deep-section-label">🏆 Highscore</div>' +
      ...
      '<button type="button" class="ui-deep-primary" data-ui-nav="tab" data-tab="highscore" style="width:100%;margin:10px 0 16px">🏆 Highscore öffnen</button>';
    ...
    return openDeepSheet({
      ...
      subtitle: 'Ranking bleibt getrennt von Duellen.', iconHtml: '🏆', bodyHtml: body
    });
  }
