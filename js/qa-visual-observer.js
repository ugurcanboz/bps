...
(function(){
  ...
  function clearOverlays(){
    ...
    [
      '#uiSheet','#assessmentsSheet','.ui-sheet','.assessments-deep-sheet','.ui-sheet-backdrop','.assessments-sheet-backdrop',
  ...
  async function runAction(action){
    ...
    entry.openedSomething=entry.after.bodyClass !== entry.before.bodyClass ||
      ...
      Array.from(document.querySelectorAll('#uiSheet,.ui-sheet,.assessments-deep-sheet,.egt-admin-modal,.python-quest-modal')).some(visible);
