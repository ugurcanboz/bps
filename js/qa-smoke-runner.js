...
(function(){
  ...
  function clearOverlays(){
    ...
    ['#uiSheet','#bpsSheet','.ui-sheet','.bps-deep-sheet','.python-quest-backdrop','.python-quest-modal'].forEach(function(sel){
  ...
  async function runSmoke(){
    ...
    for (var i=0;i<ACTIONS.length;i++){
      ...
      if(el){
        ...
        await wait(550);
        entry.after = {
          sheetVisible:Array.from(document.querySelectorAll('#uiSheet,.ui-sheet,.bps-deep-sheet')).some(visible),
