...
(function () {
  ...
  function buildShell () {
    ...
    shell.innerHTML =
      ...
      '<div class="wh-topbar">' +
        '<div class="wh-title-block">' +
          '<span class="wh-app-name">Eignungstest-Trainer</span>' +
    ...
    if (branchChip) {
      ...
      if (loginBtn) {
        window.updateLoginBtnState = function () {
          var isAdmin = !!localStorage.getItem('bps_logged_in');
        ...
        loginBtn.addEventListener('click', function () {
          if (window.EGTAdminPortal && typeof window.EGTAdminPortal.open === 'function') {
            window.EGTAdminPortal.open();
          }
        });
    ...
    setTimeout(function () { notice('Eignungstest-Trainer bereit. Viel Erfolg! 🎯'); }, 600);
  }
