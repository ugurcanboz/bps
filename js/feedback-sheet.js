...
(function () {
  ...
  function gatherBugMetadata() {
    try {
      ...
      if (window.EGTWordHubLayer && window.EGTWordHubLayer.modules) {
        const found = window.EGTWordHubLayer.modules.find(m => m.modes && m.modes.indexOf(state.selectedMode) !== -1);
    ...
    sheet.innerHTML = `
      ...
      <div class="wh-sheet-header">
        ...
        <div class="wh-sheet-info">
          ...
          <div class="wh-sheet-kicker">Hilf uns, den Eignungstest-Trainer zu verbessern</div>
        </div>
        <button class="wh-sheet-close" id="fbCloseBtn" aria-label="Schließen">✕</button>
      </div>
      <div class="wh-sheet-sep"></div>
