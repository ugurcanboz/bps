...
(function(){
  ...
  var blueprints = Object.freeze({
    A1: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:15, maxScore:100, minScore:50, format:['Schilder','kurze Nachrichten','einfache Anzeigen'] }),
        listening:Object.freeze({ durationMinutes:15, maxScore:100, minScore:50, format:['klare Durchsagen','kurze Dialoge','Zahlen/Uhrzeiten'] }),
        grammar:Object.freeze({ durationMinutes:12, maxScore:100, minScore:50, format:['Artikel','einfache Satzstellung','Verbformen'] }),
    ...
    A2: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:20, maxScore:100, minScore:52, format:['E-Mail','Anzeige','kurzer Infotext'] }),
        listening:Object.freeze({ durationMinutes:20, maxScore:100, minScore:52, format:['Telefonat','Durchsage','kurze Alltagsdialoge'] }),
        grammar:Object.freeze({ durationMinutes:15, maxScore:100, minScore:52, format:['Konnektoren','Präpositionen','Perfekt','Satzstellung'] }),
    ...
    B1: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:35, maxScore:100, minScore:55, format:['E-Mail','Anzeige','Forumsbeitrag','kurzer Sachtext'] }),
        listening:Object.freeze({ durationMinutes:30, maxScore:100, minScore:55, format:['Telefonat','Durchsage','Interview','Alltagsdialog'] }),
        grammar:Object.freeze({ durationMinutes:20, maxScore:100, minScore:58, format:['Sprachbausteine','Konnektoren','Kasus/Präpositionen','Nebensätze','Satzstellung'] }),
    ...
    B2: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:45, maxScore:100, minScore:58, format:['Sachtext','Meinungsbeitrag','Argumentationsstruktur'] }),
        listening:Object.freeze({ durationMinutes:35, maxScore:100, minScore:58, format:['Interview','Diskussion','indirekte Aussagen'] }),
        grammar:Object.freeze({ durationMinutes:22, maxScore:100, minScore:60, format:['komplexe Konnektoren','Passiv','Konjunktiv II','Nominalisierung','Textkohärenz'] }),
        writing:Object.freeze({ durationMinutes:45, maxScore:100, minScore:58, minWords:150, format:['Stellungnahme','formelle E-Mail','Argumentation'] }),
        speaking:Object.freeze({ durationMinutes:18, maxScore:100, minScore:58, minWords:95, format:['Meinung äußern','Argumentieren','Vorteile/Nachteile','Diskussion'] })
      }),
      speakingTasks:Object.freeze([
        task('b2-speaking-homeoffice','Stellungnahme Homeoffice','Nimm Stellung zum Thema Homeoffice. Nenne Vorteile, Nachteile, deine Meinung und ein konkretes Beispiel.',['Thema einordnen','mindestens zwei Vorteile','mindestens zwei Nachteile','eigene Meinung','konkretes Beispiel'],95,240,45,150)
      ]),
      writingTasks:Object.freeze([
        task('b2-writing-opinion','Stellungnahme schreiben','Schreibe eine Stellungnahme zum Thema digitale Bildung. Gehe auf Chancen, Risiken und deine begründete Meinung ein.',['Einleitung','Chancen','Risiken','begründete Meinung','Schluss'],150,240,0,0)
      ])
    }),
    C1: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:55, maxScore:100, minScore:62, format:['komplexe Sachtexte','implizite Bedeutung','Autorabsicht'] }),
        listening:Object.freeze({ durationMinutes:40, maxScore:100, minScore:62, format:['Vortrag','Diskussion','indirekte Kritik','Detailverstehen'] }),
        grammar:Object.freeze({ durationMinutes:25, maxScore:100, minScore:64, format:['Nominalstil','Register','komplexe Satzgefüge','Textkohärenz'] }),
    ...
    C2: Object.freeze({
      ...
      parts:Object.freeze({
        reading:Object.freeze({ durationMinutes:60, maxScore:100, minScore:65, format:['komplexe Analyse','Stilmittel','implizite Wertungen'] }),
        listening:Object.freeze({ durationMinutes:45, maxScore:100, minScore:65, format:['schnelle Diskussion','Nuancen','Ironie/Implikationen'] }),
        grammar:Object.freeze({ durationMinutes:28, maxScore:100, minScore:66, format:['Stilpräzision','Registerwechsel','Nuancen','komplexe Syntax'] }),
  ...
  window.LanguageExamBlueprints = Object.freeze({
    __version:'G54.38C.14-exam-blueprints-hardmode-total-qa',
    rubric:commonRubric,
    levels:blueprints,
