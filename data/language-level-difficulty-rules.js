/* Language Academy · Phase 38D.7
   ...
   Phase 38D.7 nutzt die Matrix für B2-Gesamt-QA und Hardmode-Endsimulation. */
(function(){
  'use strict';
  ...
  var rules = freezeDeep({
    ...
    B2:{
      ...
      readingWords:[320,760], listeningWords:[260,650], writingWords:[180,280], speakingWords:[180,350],
  ...
  window.LanguageLevelDifficultyRules = Object.freeze({
    __version:'G54.38D.6-level-differentiation-rules',
    get:get,
    list:list,
    summary:summary,
