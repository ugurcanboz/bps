...
(function(){
  ...
  function poolInfo(){
    return { version:VERSION, reading:readingPool.length, listening:listeningPool.length, writing:writingPool.length, speaking:speakingPool.length, combinations:readingPool.length * listeningPool.length * writingPool.length * speakingPool.length, edgeCases:hardEdgeCases.length, writingRubric:'38C.9 strict formal writing', speakingRubric:'38C.10 strict speaking examiner' };
  }
