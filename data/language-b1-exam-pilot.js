...
(function(){
  ...
  var strictRules = [
    ...
    'Bewertet werden nur bestätigte Texte/Transkripte und nicht rohe fehlerhafte Spracherkennung.',
  ...
  var grammarPool = freezeDeep([
    {
      ...
      durationMinutes:20,
      intro:'Deutsch-Vollprüfung: Grammatik zählt direkt. Wähle die Lösung, die grammatisch korrekt ist und zur Situation passt.',
      passScore:75,
      questions:[
      ...
      hardFailHints:['Unter 75% ist der Grammatikblock im Deutsch-Vollprüfung kritisch.','Nur Lesen/Hören gut reicht nicht: Satzstellung, Kasus und Konnektoren werden separat geprüft.']
    },
    {
