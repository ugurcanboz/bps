...
(function(){
  ...
  var DIFFICULTIES = Object.freeze(['learn','easy','training','novuraExams','exam','hard']);
  ...
  function validateGrid(scenario, errors, warnings){
    ...
    if(total !== 70 && scenario.difficulty === 'novuraExams') add(warnings, 'GRID_NOT_70_CTC', 'Novura Exams-Standard sollte 10 x 7 = 70 Felder nutzen.', { total:total });
  }
