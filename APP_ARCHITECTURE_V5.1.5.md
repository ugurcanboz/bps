...
Die Runtime bleibt für maximale PWA-Kompatibilität als `js/app.js` gebündelt. Die Wartung erfolgt ab V5.1.5 über die modularen Source-Dateien unter `js/src/`.
...
- Framework-Version: 5.1.5
- Cache: eignungstest-trainer-v515-cloud-highscore-cache
- Storage-Key: eignungstest_trainer_v515_results
- Profil-Key: eignungstest_trainer_profile_v515
