# Eignungstest-Trainer V6.0.0 Cloud Diagnostics Stable
...
Die Runtime bleibt für maximale PWA-Kompatibilität als `js/app.js` gebündelt. Die Wartung erfolgt ab V6.0.0 über die modularen Source-Dateien unter `js/src/`.
...
- Cache: eignungstest-trainer-v600-cloud-highscore-cache
- Storage-Key: eignungstest_trainer_v600_results
- Profil-Key: eignungstest_trainer_profile_v600
