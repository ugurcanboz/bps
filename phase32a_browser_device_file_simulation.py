...
result={'ok':False,'phase':'32A','mode':'file-url','devices':[],'error':None}
try:
    ...
    url=(root/'tests_phase32a_b1_course_speaking_structure.html').as_uri()
    ...
    result['error']=str(e)
(root/'phase32a_browser_device_file_simulation_result.json').write_text(json.dumps(result,indent=2,ensure_ascii=False))
