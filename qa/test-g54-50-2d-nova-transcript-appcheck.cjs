...
ok('new service worker cache invalidates previous UI',()=>{const sw=read('service-worker.js');assert(sw.includes("var VERSION = '"+currentVersion+"-2026-07-13'"));assert(sw.includes("var CACHE_NAME = '"+currentCache+"'"));});
