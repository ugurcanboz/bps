...
ok('release version is G54.50.2G',()=>assert(read('js/core/app-config.js').includes("var VERSION = 'G54.50.2G'")));
...
ok('new service worker cache invalidates previous UI',()=>{const sw=read('service-worker.js');assert(sw.includes("var VERSION = 'G54.50.2G-2026-07-13'"));assert(sw.includes("var CACHE_NAME = 'egt-trainer-g54-50-2g'"));});
