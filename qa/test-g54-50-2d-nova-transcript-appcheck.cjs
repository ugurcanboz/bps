...
ok('new service worker cache invalidates previous UI',()=>{const sw=read('service-worker.js');assert(sw.includes("var VERSION = 'G54.50.2F-2026-07-12'"));assert(sw.includes("var CACHE_NAME = 'egt-trainer-g54-50-2f'"));});
