...
ok('service worker caches new navigation assets',()=>{assert(sw.includes('./js/core/deep-sheet-navigation.js'));assert(sw.includes('./css/deep-sheet-navigation.css'));assert(sw.includes(currentCache));});
