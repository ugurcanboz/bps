...
Ohne dieses Deployment bleibt die bisherige Function aktiv. G54.50.2D erlaubt ausschließlich dem einmaligen `bootstrapAdmin`-Endpunkt den Erstaufruf vor einer vollständigen App-Check-Einrichtung. Alle anderen privilegierten Cloudaktionen bleiben weiterhin App-Check-pflichtig.
