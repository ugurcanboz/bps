...
Dieser Stand behebt überlappende, zerlegte oder optisch verschobene Texte in Deep Sheets, Karten und responsiven Grids. Die universelle Deep-Sheet-Navigation aus G54.50.2I bleibt vollständig erhalten.

Wichtigste Änderungen:
- optisch zentrierte Deep-Sheet-Titel mit vollständigem Zweizeilen-Fallback
- kein appweites Zerlegen langer Wörter in einzelne Buchstaben
- Simulation-Center-Badges liegen unter dem Karteninhalt statt darüber
- responsive Kartenraster mit Mindestbreiten
- konsistente Titel-, Beschreibungs- und Icon-Ausrichtung
